...
**影响文件**：`ttk/core_modules/simulator/npusim_runner.py`（核心）、`ttk/cli/sim_args.py`、`ttk/utilities/classes.py`、`tests/core_modules/test_simulator_backend.py`（+6 测试）、`docs/TTK_NPUSim使用指南.md`。
