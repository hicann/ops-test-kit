...
_MIGRATED_APIS = (
    "AlltoAllAllGatherBatchMatMul", "BatchMatMulReduceScatterAlltoAll",
    "GroupedMatMulAlltoAllv", "AlltoAllvGroupedMatMul",
    "MoeDistributeDispatch", "MoeDistributeCombine",
    "AllGatherMatmul", "MatmulReduceScatter",
    "MatmulAlltoAll", "AlltoAllMatmul",
    # A5 operators (quant / V2 / add_rms_norm variants)
    "MatmulAllReduce", "WeightQuantMatmulAllReduce",
    "QuantMatmulAllReduce", "AllGatherMatmulV2",
    "MatmulReduceScatterV2", "InplaceMatmulAllReduceAddRmsNorm",
    "MatmulAllReduceAddRmsNorm", "GroupedMatMulAllReduce",
    "QuantAllReduce", "QuantReduceScatter",
    "QuantGroupedMatMulAlltoAllv", "AlltoAllvQuantGroupedMatMul",
)
